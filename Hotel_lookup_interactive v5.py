...
attachments_frame = ttk.LabelFrame(setup_frame, text="Attachments", padding=10)
attachments_frame.pack(fill="x", padx=5, pady=5)
...
attach_entry = ttk.Entry(attachments_frame, textvariable=attachments_root_var, width=50)
